define("kirin/icheck/1.0.2/icheck-debug", [ "jquery/jquery/1.7.2/jquery-debug.js" ], function(require, exports, module) {
        ...
        $.fn[_iCheck] = function(options, fire) {
            ...
            if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(options)) {
                ...
                var settings = $.extend({
                    ...
                    labelHover: true
                }, options), selector = settings.handle, hoverClass = settings.hoverClass || "hover", focusClass = settings.focusClass || "focus", activeClass = settings.activeClass || "active", labelHover = !!settings.labelHover, labelHoverClass = settings.labelHoverClass || "hover", // Setup clickable area
                ...
                return stack.each(function() {
                    ...
                    helper.on(_click + " mousedown mouseup mouseover mouseout " + _touch, function(event) {
                        var type = event[_type], // mousedown|mouseup
