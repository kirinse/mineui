define("kirin/utils/1.0.0/array-debug", [ "./karray-debug", "arale/class/1.2.0/class-debug" ], function(require, exports, module) {
    var KArray = require("./karray-debug");
...
define("kirin/utils/1.0.0/karray-debug", [ "arale/class/1.2.0/class-debug" ], function(require, exports, module) {
    var Class = require("arale/class/1.2.0/class-debug");
    // var $S = require('./string');
    // console.log($S);
    var KArray = Class(Array).extend({
        /**
     * 类初始化
     */
    ...
    module.exports = KArray;
    KArray.prototype["toString"] = function() {
        return this.arr.toString();
    };
    KArray.prototype["valueOf"] = function() {
