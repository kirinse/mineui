...
define("alipay/select/1.0.2/select-debug", [ "arale/overlay/1.0.0/overlay-debug", "$-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.0/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug", "./select-tpl-debug" ], function(require, exports, module) {
    var Overlay = require("arale/overlay/1.0.0/overlay-debug");
    var $ = require("$-debug");
    var Templatable = require("arale/widget/1.0.3/templatable-debug");
    var template = require("./select-tpl-debug");
...
define("alipay/select/1.0.2/select-tpl-debug", [ "gallery/handlebars/1.0.0/handlebars-debug" ], function(require, exports, module) {
        ...
        module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
            ...
            function program1(depth0, data, depth1) {
                ...
                stack2 = helpers["if"].call(depth0, depth0.disabled, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program2, data, depth1),
                    data: data
                });
                if (stack2 || stack2 === 0) {
                    buffer += stack2;
                ...
                buffer += escapeExpression(stack2) + '" data-default-selected="';
                ...
                buffer += escapeExpression(stack2) + '" data-disabled="';
                ...
                buffer += "\n            ";
                stack2 = helpers["if"].call(depth0, depth0.options, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program4, data, depth1),
                    data: data
                });
                if (stack2 || stack2 === 0) {
                    buffer += stack2;
            ...
            function program4(depth0, data, depth2) {
                ...
                stack1 = helpers.each.call(depth0, depth0.options, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program5, data, depth2),
                    data: data
                });
                if (stack1 || stack1 === 0) {
                    buffer += stack1;
            ...
            function program5(depth0, data, depth3) {
                var buffer = "", stack1, stack2;
                buffer += '\n                    <li data-role="item" class="' + escapeExpression((stack1 = depth3.classPrefix, 
                typeof stack1 === functionType ? stack1.apply(depth0) : stack1)) + "-item ";
                stack2 = helpers["if"].call(depth0, depth0.disabled, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program6, data, depth3),
                    data: data
                });
                if (stack2 || stack2 === 0) {
                    buffer += stack2;
                ...
                stack2 = helpers["if"].call(depth0, depth0.options, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program8, data, depth3),
                    data: data
                });
                if (stack2 || stack2 === 0) {
                    buffer += stack2;
            ...
            function program6(depth0, data, depth4) {
                var buffer = "", stack1;
                buffer += escapeExpression((stack1 = depth4.classPrefix, typeof stack1 === functionType ? stack1.apply(depth0) : stack1)) + "-item-disabled";
                return buffer;
            }
            function program8(depth0, data, depth4) {
                ...
                stack1 = helpers.each.call(depth0, depth0.options, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program9, data, depth4),
                    data: data
                });
                if (stack1 || stack1 === 0) {
                    buffer += stack1;
            ...
            function program9(depth0, data, depth5) {
                var buffer = "", stack1, stack2;
                buffer += '\n                                <li data-role="item" class="' + escapeExpression((stack1 = depth5.classPrefix, 
                typeof stack1 === functionType ? stack1.apply(depth0) : stack1)) + "-item ";
                stack2 = helpers["if"].call(depth0, depth0.disabled, {
                    hash: {},
                    inverse: self.noop,
                    fn: self.programWithDepth(program10, data, depth5),
                    data: data
                });
                if (stack2 || stack2 === 0) {
                    buffer += stack2;
            ...
            function program10(depth0, data, depth6) {
                var buffer = "", stack1;
                buffer += escapeExpression((stack1 = depth6.classPrefix, typeof stack1 === functionType ? stack1.apply(depth0) : stack1)) + "-item-disabled";
                return buffer;
            }
            buffer += '<div class="';
