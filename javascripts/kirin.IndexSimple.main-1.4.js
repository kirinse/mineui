...
kirin.index.randomBank=function(a,e,b){
  e&&(a&&a.length&&(b=a[Math.floor(a.length*Math.random())]),e.attr("class",b))
};

kirin.index.banner=function(a,e){
  var b=kirin.index.utils,c=parseInt(b.getCookie("indexBannerIsShow")||0);
  $("indexBanner");
