 ...
 */
arale.declare('aralex.Switchable', [aralex.Widget], {
		...
		postCreate: function() {
             ...
             * @param {Number | String} currentTrigger-before-0 起始trigger
             * @param {Number | String} targetTrigger-before-1 目标trigger
             * @param {Number | String} currentTrigger-after-0 起始trigger
             * @param {Number | String} targetTrigger-after-1 目标trigger
             * @example
             ...
             * @event
             * @memberOf aralex.Switchable
             * @param {Number | String} currentView-before-0 起始view
             * @param {Number | String} targetView-before-1 目标view
             * @param {Number | String} currentView-after-0 起始view
             * @param {Number | String} targetView-after-1 目标view
             * @example
...
/**Last Changed Author: shuai.shao--Last Changed Date: Wed May 11 21:30:29 CST 2011**/