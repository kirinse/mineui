define("kirin/utils/1.0.0/kstring", ["./kkstring"], function(require, exports, module) {
  var KKString = require('./kkstring');
  
	var StringFactory = function(strr){	
		return new KKString(strr);
	}
	StringFactory.fn =KKString.prototype;
	return StringFactory;
});

define("kirin/utils/1.0.0/kkstring",["class","./karray"], function(require, exports, module) {
  var Class = require("class");
  var $A = require("./karray");
  ...
  var KKString = Class(String).extend({
    /**
     * 类初始化
     */
  ...
  module.exports = KKString;
	KKString.prototype['toString'] = function(){
		return this.str;
	};
});