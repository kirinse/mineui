define("kirin/utils/1.0.0/karray",["./kkarray"],function(require, exports, module){
  
  var KArray = require("./kkarray");
  ...
  ArrayFactory.fn = KArray.prototype;

  return ArrayFactory;
  
});

define("kirin/utils/1.0.0/kkarray",["class", "./kstring"],function(require, exports, module){
  var Class = require("class");
  var KString = require("./kstring");
  var KKArray = Class(Array).extend({
    /**
     * 类初始化
     */
     ...
     * keys.associate(vals); //returns {'Cow': 'Moo', 'Pig': 'Oink', 'Dog': 'Woof', 'Cat': 'Miao'}
     * @return {Array}
     */
     ...
     */
    random: function() {
      return (this.arr && this.arr[Math.floor(Math.random() * this.arr.length)]) || null;
    },
  ...
  module.exports = KKArray;
  KKArray.prototype['toString'] = function() {
      return this.arr.toString();
  };
  KKArray.prototype['valueOf'] = function() {
