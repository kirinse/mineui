define("alipay/poptip/1.4.0/poptip-debug", [ "arale/overlay/1.0.1/overlay-debug", "$-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug", "./poptip-icon-debug.css", "./poptip-tpl-debug.js" ], function(require, exports, module) {
    var Overlay = require("arale/overlay/1.0.1/overlay-debug");
    var Templatable = require("arale/widget/1.0.3/templatable-debug");
    require("./poptip-icon-debug.css");
    var ICONS = {
    ...
    var Poptip = Overlay.extend({
        ...
        attrs: {
            template: require("./poptip-tpl-debug"),
            // 提示指向的目标元素
            target: null,
            // 提示内容
            content: "",
...
define("alipay/poptip/1.4.0/poptip-icon-debug.css", [], function() {
...
define("alipay/poptip/1.4.0/poptip-tpl-debug", [ "gallery/handlebars/1.0.0/handlebars-debug" ], function(require, exports, module) {
