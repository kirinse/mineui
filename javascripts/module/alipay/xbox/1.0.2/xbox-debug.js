define("alipay/xbox/1.0.2/xbox-debug", [ "$-debug", "arale/dialog/1.0.1/dialog-debug", "arale/overlay/1.0.1/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/overlay/1.0.1/mask-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug", "alipay/object-shim/1.0.0/object-shim-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Dialog = require("arale/dialog/1.0.1/dialog-debug");
    var objectShim = require("alipay/object-shim/1.0.0/object-shim-debug");
    var hideFuncTmp;
    require("alipay/xbox/1.0.2/xbox.css");
...
define('alipay/xbox/1.0.2/xbox.css', [], function() {
