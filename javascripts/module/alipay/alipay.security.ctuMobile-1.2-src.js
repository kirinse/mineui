 ...
 * @name counter
 * @module counter
 * @namespace window.alipay.security.ctuMmobile
 * @param
 * @requires light
 * @author 右丞
 * @Date 2012.07.11
...
light.has('/alipay/security/ctuMobile') || (function(light, security, undefined) {

try{
  if(window == window.parent) {
    light.client.storage.set('ctuMobileSendTime', -1);
  }
}catch(e){}
...
var members = {
    ...
    if(window != window.parent) {
      var curTime = (new Date()).getTime(),
          lastSentTime = Number(light.client.storage.get('ctuMobileSendTime'));
      if(curTime - lastSentTime < 0){
		...
		light.request(o.ajaxUrl, params, {
          ...
          try{
            if(window != window.parent) {
              light.client.storage.set('ctuMobileSendTime', (new Date()).getTime());
            }else{
              light.client.storage.set('ctuMobileSendTime', -1);
            }
          }catch(e){}
...
ctuMobile = light.register('/alipay/security/ctuMobile', window, light.deriveFrom(security.base, members, ctuMobile));

})(window.light, alipay.security);

/** end ---ctuMobile.js---*/
/**Last Changed Author: shuai.shao--Last Changed Date: Wed Jun 19 20:28:08 CST 2013**/
/**alipay.security.ctuMobile-1.2**/
/** CurrentDeveloper: shawn**/
/** DeployDate: Wed Jun 19 20:29:11 CST 2013**/
