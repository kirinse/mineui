/** begin ---riskMobileBank.js---*/
/**
 * @namespace window.alipay.security.riskMobileBank
 * @param
 * @requires light
 */

light.has('/alipay/security/riskMobileBank') || (function(light, security, undefined) {
try{
  if(window == window.parent) {
    light.client.storage.set('riskMobileBankSendTime', -1);
  }
}catch(e){}
...
var members = {
    ...
    if(window != window.parent) {
      var curTime = (new Date()).getTime(),
          lastSentTime = Number(light.client.storage.get('riskMobileBankSendTime'));
      if(curTime - lastSentTime < 0){
		...
		params.validateProductName = 'risk_mobile_bank';
		light.request(o.ajaxUrl, params, {
          ...
          try{
            if(window != window.parent) {
              light.client.storage.set('riskMobileBankSendTime', (new Date()).getTime());
            }else{
              light.client.storage.set('riskMobileBankSendTime', -1);
            }
          }catch(e){}
...
riskMobileBank = light.register('/alipay/security/riskMobileBank', window, light.deriveFrom(security.base, members, riskMobileBank));

})(window.light, alipay.security);

/** end ---riskMobileBank.js---*/
/**Last Changed Author: shuai.shao--Last Changed Date: Wed Jun 19 20:40:14 CST 2013**/
/**alipay.security.riskMobileBank-1.3**/
/** CurrentDeveloper: shawn**/
/** DeployDate: Wed Jun 19 20:40:53 CST 2013**/
