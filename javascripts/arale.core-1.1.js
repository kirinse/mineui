...
var arale=arale||{
	...
	inherits:function(childCtor,parentCtor){
		...
		childCtor.superCouns=parentCtor;childCtor.prototype=new tempCtor();
	...
	getUniqueId:function(str){
		var id=arale.getUniqueId._id||1;arale.getUniqueId._id=++id;
	...
	arale.augment(CArray,{
		...
		erase:function(item){
			...
			this.each(function(member,index){
				if(member===item){arr.splice(index,1)}
			});
			return arr
		},
		empty:function(){
